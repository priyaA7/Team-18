function initAutocomplete() {
    ...
    marker3 = [];
    let rentRef = firebase.database().ref('Rentals');
    rentRef.on('value',function(snapshot) {
        snapshot.forEach(function(child){
            var childs = child.val();
            var postion = {lat:parseFloat(childs.latitude),lng:parseFloat(childs.longitude)}
            marker3.push(postion)
